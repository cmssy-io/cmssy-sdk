...
| `fields.relation`     | Model record binding      | `CmssyModelRecord[]` or `CmssyModelRecord \| undefined` | `model`, `mode`, `multiple`, `sort`, `limit` - see [Models for data](./models-for-data.md) |
